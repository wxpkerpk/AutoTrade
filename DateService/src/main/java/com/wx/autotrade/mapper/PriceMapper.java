...
public interface PriceMapper {
    ...
    @Insert("INSERT INTO price(name,date,maxPrice,minPrice,avgPrice,depth,intervals,openPrice,closePrice,id) VALUES(#{name}, #{date}, #{maxPrice}, #{minPrice}, #{avgPrice}, #{depth}, #{intervals}, #{openPrice}, #{closePrice},#{id})")
